## 1. Front-end web development introduction

The first day. Collect some interesting websites.
...
- [https://tympanus.net/Development/AudioVisualizers/](https://tympanus.net/Development/AudioVisualizers/)